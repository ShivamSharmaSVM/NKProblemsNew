...
public class FindNumberOfHalfNode
{
	public static void main(String[] args)
	{
		MyBinaryTree tree = MyBinaryTree.getComplexBinaryTree();
		System.out.println("No. of half node: "+getHalfNodeCount(tree));
	}
	public static int getHalfNodeCount(MyBinaryTree tree)
	{
		int count = 0;
		...
		while(!queue.isEmpty())
		{
			...
			if(!(temp.hasLeftNode() && temp.hasRightNode()) && !temp.isExternal())
				count++;
			else
			{
